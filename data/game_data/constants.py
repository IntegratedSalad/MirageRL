...
INVENTORY_MAIN_WINDOW_WIDTH = 43
INVENTORY_MAIN_WINDOW_HEIGHT = SCREEN_HEIGHT

INVENTORY_SECONDARY_WINDOW_WIDTH = 24
INVENTORY_SECONDARY_WINDOW_HEIGHT = SCREEN_HEIGHT
# Colors
